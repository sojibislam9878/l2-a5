...
export const metadata: Metadata = {
  title: "My bookings",
  description: "Track every service you have booked on FixItNow.",
};
...
const EmptyState = () => (
  <div className="flex flex-col items-center gap-3 rounded-2xl border border-dashed px-6 py-16 text-center">
    ...
    <p className="max-w-sm text-sm text-muted-foreground">
      When you book a technician, your request will show up here so you can
      track it from request to receipt.
    </p>
    <Button
      asChild
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            {bookings.length === 0
              ...
              : `${bookings.length} ${bookings.length === 1 ? "booking" : "bookings"}, newest first.`}
          </p>
        </div>
        {bookings.length > 0 && (
